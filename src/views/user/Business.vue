      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          <el-tooltip effect="dark" content="修改" placement="top">
            <i class="iconfont icon-xiugai1" @click="handleEdit(scope.row)"></i>
          </el-tooltip>
          <el-tooltip effect="dark" content="注销" placement="top">
            <i class="iconfont icon-zhuxiao" @click="handleDelete(scope.row)"></i>
          </el-tooltip>
        </template>
      </el-table-column>
    </el-table>
